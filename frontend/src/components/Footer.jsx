...
const Footer = () => {
    ...
    return (
        <footer className="bg-liquid-glass-footer text-stone-800 font-primary pt-16 sm:pt-24 pb-10 sm:pb-12 px-4 -mx-4 sm:-mx-[3vw] md:-mx-[4vw] lg:-mx-[5vw] sm:px-[3vw] md:px-[4vw] lg:px-[5vw] relative overflow-hidden">
            ...
            <div className="container mx-auto max-w-7xl relative z-10">
                ...
                <div className="flex flex-col lg:flex-row justify-between gap-12 lg:gap-24 mb-14 sm:mb-20">
                    ...
                    <div className="lg:w-7/12 grid grid-cols-2 sm:grid-cols-3 gap-8 sm:gap-8">
                        {/* Sacred Services */}
                        ...
                        {/* Connectivity */}
                        <div className="space-y-6 col-span-2 sm:col-span-1 mt-4 sm:mt-0">
                            ...
                            <div className="space-y-5 text-xs font-semibold">
                                <div className="flex gap-3.5 items-start min-w-0">
                                    ...
                                    <p className="leading-relaxed text-stone-600 break-words">
                                        {settings?.address || (
                                            <>
                                ...
                                <div className="flex items-center gap-3.5 text-stone-600 min-w-0">
                                    <Phone size={14} className="text-orange-600 shrink-0" aria-hidden="true" />
                                    <p className="truncate">{settings?.phone || "+91 91234 56789"}</p>
                                </div>
                                <div className="flex items-center gap-3.5 text-stone-600 min-w-0">
                ...
                {/* Footer Bottom Bar */}
                <div className="pt-10 border-t border-black/[0.06] flex flex-col md:flex-row justify-between items-center gap-6 text-center md:text-left">
                    <p className="text-[9px] uppercase tracking-wider sm:tracking-[0.2em] text-stone-500 font-medium leading-relaxed max-w-md md:max-w-none">
                        © {new Date().getFullYear()} Shri Kadasiddheshwar Temple Trust • Banahatti. All Rights Reserved.
                    </p>
                    <div className="flex items-center justify-center gap-2 text-[9px] uppercase tracking-wider sm:tracking-[0.2em] text-stone-500 font-medium">
